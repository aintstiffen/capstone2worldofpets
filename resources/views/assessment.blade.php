        ...
        <main class="flex-1">
            <div class="container py-8 max-w-3xl mx-auto">
                ...
                <template x-if="!petType">
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <button class="p-6 border rounded-lg hover:bg-gray-50" @click="petType = 'dog'">🐶 Dog</button>
                            <button class="p-6 border rounded-lg hover:bg-gray-50" @click="petType = 'cat'">🐱 Cat</button>
                        </div>
                    </div>
                </template>
                ...
                <template x-if="petType && !showResults">
                    <div>
                        <h2 class="text-2xl font-bold mb-4">Question <span x-text="currentStep + 1"></span> of <span
                                x-text="questions.length"></span></h2>
                            ...
                            <div class="space-y-2">
                                <template x-for="option in questions[currentStep].options" :key="option.value">
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" :name="'q' + currentStep" :value="option.value"
                        ...
                        <div class="flex justify-between mt-4">
                            <button class="px-4 py-2 border rounded" @click="prevStep" x-show="currentStep > 0">←
                                Back</button>
                            <button class="px-4 py-2 bg-blue-500 text-white rounded" @click="nextStep"
                ...
                <template x-if="showResults">
                    <div>
                        ...
                        <button class="mt-6 px-4 py-2 bg-blue-500 text-white rounded" @click="restart">Start Over</button>
                    </div>
                </template>
                ...
                calculateResults() {
                    ...
                    if (this.petType === 'dog') {
                        this.recommendedBreeds = [{
                                ...
                                description: "Friendly, active, and loyal."
                            },
                            {
                                name: "Shiba Inu",
                                image: "https://placedog.net/400/300?id=2",
                                description: "Independent and alert."
                            }
                        ];
                    } else {
                        this.recommendedBreeds = [{
                                ...
                                description: "Social, intelligent, and vocal."
                            },
                            {
                                name: "Persian",
                                image: "https://placekitten.com/401/300",
                                description: "Calm, affectionate, and gentle."
                            }
                        ];
                    }
                },
