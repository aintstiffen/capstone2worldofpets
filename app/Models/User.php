...
// Temporarily remove MustVerifyEmail to avoid email issues on Railway
// Change back to: class User extends Authenticatable implements MustVerifyEmail
// when you configure email properly
